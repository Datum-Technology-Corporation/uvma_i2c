...
### DV ###
# Local
export DV_UVMA_AXIS_SRC_PATH=${PROJECT_DV_DIR}/uvma_axis/src
export DV_UVME_AXIS_ST_SRC_PATH=${PROJECT_DV_DIR}/uvme_axis_st/src
export DV_UVMT_AXIS_ST_SRC_PATH=${PROJECT_DV_DIR}/uvmt_axis_st/src
...
>>>>>>> branch 'main' of https://github.com/Datum-Technology-Corporation/uvma_i2c.git
